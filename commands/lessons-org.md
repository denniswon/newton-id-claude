...
- **Popup Protocol Gotchas** — cross-component popup/messaging patterns unique to this codebase
...
- **Identity/Signing Patterns** — identity and signing implementation lessons
